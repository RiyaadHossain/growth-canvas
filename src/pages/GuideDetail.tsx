...
import { usePlaybook } from "@/lib/playbooksApi";
...
export default function GuideDetail() {
  ...
  if (!item) {
    if (isError) return <Navigate to="/resources/guides-playbooks" replace />;
    return <Navigate to="/resources/guides-playbooks" replace />;
  }
